...
function CompactToolCall({
  ...
  return (
    <div style={{ position: "relative", padding: "4px 12px 4px 24px" }}>
      ...
      />
      <div style={{ position: "absolute", left: 5, top: 9, width: 12, height: 12, display: "flex", alignItems: "center", justifyContent: "center", color: "#858585" }}>
